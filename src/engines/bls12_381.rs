...
pub const BLS12_381_MODULUS: U384Repr = U384Repr([
    0xb9feffffffffaaab,
    0x1eabfffeb153ffff,
    0x6730d2a0f6b0f624,
    0x64774b84f38512bf,
...
const BLS12_381_R: U384Repr = U384Repr([
    0x760900000002fffd,
    0xebf4000bc40c0002,
    0x5f48985753c758ba,
    0x77ce585370525745,
...
const BLS12_381_R2: U384Repr = U384Repr([
    0xf4df1f341c341746,
    0x0a76e6a609d104f1,
    0x8de5476c4c95b6d5,
    0x67eb88a9939d83c0,
...
const BLS12_381_FP_NON_RESIDUE_REPR: U384Repr = U384Repr([
    0x43f5fffffffcaaae,
    0x32b7fff2ed47fffd,
    0x07e83a49a2e99d69,
    0xeca8f3318332bb7a,
...
const BLS12_381_FP_NON_RESIDUE: decl_fp!(U384Repr) =
    repr_into_fp!(BLS12_381_FP_NON_RESIDUE_REPR, U384Repr, BLS12_381_FIELD);

pub const BLS12_381_FP_ZERO: decl_fp!(U384Repr) =
    repr_into_fp!(REPR_ZERO, U384Repr, BLS12_381_FIELD);

pub const BLS12_381_FP_ONE: decl_fp!(U384Repr) =
    repr_into_fp!(BLS12_381_R, U384Repr, BLS12_381_FIELD);

const BLS12_381_EXTENSION_2_FROB_COEFF_0_REPR: U384Repr = U384Repr([
    0x760900000002fffd,
    0xebf4000bc40c0002,
    0x5f48985753c758ba,
    0x77ce585370525745,
...
const BLS12_381_EXTENSION_2_FROB_COEFF_1_REPR: U384Repr = U384Repr([
    0x43f5fffffffcaaae,
    0x32b7fff2ed47fffd,
    0x07e83a49a2e99d69,
    0xeca8f3318332bb7a,
...
pub const BLS12_381_EXTENSION_2_FIELD: Extension2<'static, U384Repr, PrimeField<U384Repr>> =
    Extension2::<'static, U384Repr, PrimeField<U384Repr>> {
        ...
        frobenius_coeffs_c1: [
            BLS12_381_EXTENSION_2_FROB_COEFF_0,
            BLS12_381_EXTENSION_2_FROB_COEFF_1,
        ],
...
const BLS12_381_FP2_NON_RESIDUE_C0_REPR: U384Repr = U384Repr([
    0x760900000002fffd,
    0xebf4000bc40c0002,
    0x5f48985753c758ba,
    0x77ce585370525745,
...
const BLS12_381_FP2_NON_RESIDUE_C1_REPR: U384Repr = U384Repr([
    0x760900000002fffd,
    0xebf4000bc40c0002,
    0x5f48985753c758ba,
    0x77ce585370525745,
...
const BLS12_381_FP2_NON_RESIDUE_C0: decl_fp!(U384Repr) =
    repr_into_fp!(BLS12_381_FP2_NON_RESIDUE_C0_REPR, U384Repr, BLS12_381_FIELD);

const BLS12_381_FP2_NON_RESIDUE_C1: decl_fp!(U384Repr) =
    repr_into_fp!(BLS12_381_FP2_NON_RESIDUE_C1_REPR, U384Repr, BLS12_381_FIELD);
...
const BLS12_381_B_FOR_G1_REPR: U384Repr = U384Repr([
    0xaa270000000cfff3,
    0x53cc0032fc34000a,
    0x478fe97a6b0a807f,
    0xb1d37ebee6ba24d7,
...
const BLS12_381_B_FOR_G2_C0_REPR: U384Repr = U384Repr([
    0xaa270000000cfff3,
    0x53cc0032fc34000a,
    0x478fe97a6b0a807f,
    0xb1d37ebee6ba24d7,
...
const BLS12_381_B_FOR_G2_C1_REPR: U384Repr = U384Repr([
    0xaa270000000cfff3,
    0x53cc0032fc34000a,
    0x478fe97a6b0a807f,
    0xb1d37ebee6ba24d7,
...
pub const BLS12_381_G1_CURVE_PARAMETERS: CurveOverFpParameters<
    'static,
    U384Repr,
    PrimeField<U384Repr>,
...
pub const BLS12_381_G2_CURVE_PARAMETERS: CurveOverFp2Parameters<
    'static,
    U384Repr,
    PrimeField<U384Repr>,
...
pub const BLS12_381_EXTENSION_6_FIELD: Extension3Over2<'static, U384Repr, PrimeField<U384Repr>> =
    Extension3Over2::<'static, U384Repr, PrimeField<U384Repr>> {
        ...
        field: &BLS12_381_EXTENSION_2_FIELD,
        frobenius_coeffs_c1: [
            BLS12_381_FP6_FROB_C1_0,
            BLS12_381_FP6_FROB_C1_1,
        ...
        frobenius_coeffs_c2: [
            BLS12_381_FP6_FROB_C2_0,
            BLS12_381_FP6_FROB_C2_1,
...
pub const BLS12_381_EXTENSION_12_FIELD: Extension2Over3Over2<
    'static,
    U384Repr,
    PrimeField<U384Repr>,
> = Extension2Over3Over2::<'static, U384Repr, PrimeField<U384Repr>> {
    ...
    frobenius_coeffs_c1: [
        BLS12_381_FP12_FROB_C1_0,
        BLS12_381_FP12_FROB_C1_1,
        BLS12_381_FP12_FROB_C1_2,
        BLS12_381_FP12_FROB_C1_3,
        BLS12_381_FP12_FROB_C1_4,
        BLS12_381_FP12_FROB_C1_5,
        BLS12_381_FP12_FROB_C1_6,
        BLS12_381_FP12_FROB_C1_7,
        BLS12_381_FP12_FROB_C1_8,
        BLS12_381_FP12_FROB_C1_9,
        BLS12_381_FP12_FROB_C1_10,
        BLS12_381_FP12_FROB_C1_11,
    ],
    frobenius_coeffs_are_calculated: true,
};

pub const BLS12_381_G1_CURVE: WeierstrassCurve<
    'static,
    CurveOverFpParameters<'static, U384Repr, PrimeField<U384Repr>>,
...
pub const BLS12_381_G2_CURVE: WeierstrassCurve<
    'static,
    CurveOverFp2Parameters<'static, U384Repr, PrimeField<U384Repr>>,
...
pub const BLS12_381_G1_GENERATOR: CurvePoint<
    'static,
    CurveOverFpParameters<'static, U384Repr, PrimeField<U384Repr>>,
...
pub const BLS12_381_G2_GENERATOR: CurvePoint<
    'static,
    CurveOverFp2Parameters<'static, U384Repr, PrimeField<U384Repr>>,
...
pub const BLS12_381_G1_CURVE_ISOGENY: WeierstrassCurve<
    'static,
    CurveOverFpParameters<'static, U384Repr, PrimeField<U384Repr>>,
> = WeierstrassCurve::<'static, CurveOverFpParameters<'static, U384Repr, PrimeField<U384Repr>>> {
...
pub const BLS12_381_G1_MAPPING_H_EFF: [u64; 1] = [0xd201000000010001];
...
pub const BLS12_381_G2_CURVE_ISOGENY: WeierstrassCurve<
    'static,
    CurveOverFp2Parameters<'static, U384Repr, PrimeField<U384Repr>>,
> = WeierstrassCurve::<'static, CurveOverFp2Parameters<'static, U384Repr, PrimeField<U384Repr>>> {
...
pub mod mapping {
    ...
    > {
        ...
        let (x_prime, y_prime) =
            simplified_swu_fp(el, &swu, coerce_static(el, &BLS12_381_G1_CURVE_ISOGENY));
        ...
        if point.is_on_curve() == false {
            return Err(ApiError::InputError(
                "mapped point is not on the curve".to_owned(),
            ));
        }
    ...
    > {
        ...
        let (x_prime, y_prime) =
            simplified_swu_fp2(el, &swu, coerce_static(el, &BLS12_381_G2_CURVE_ISOGENY));
        ...
        let mut cofactor_cleared =
            point.wnaf_mul_with_window_size(&BLS12_381_G2_MAPPING_H_EFF[..], 5);
        cofactor_cleared.normalize();
...
mod test {
    ...
    fn test_g1_mul_by_zero() {
        let mut input_encoding =
            serialize_g1_point(48, &BLS12_381_G1_GENERATOR).expect("must serialize a generator");
        let scalar = [0u64];
