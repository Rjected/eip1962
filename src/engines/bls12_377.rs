...
pub const BLS12_377_MODULUS: U384Repr = U384Repr([
    0x8508c00000000001,
    0x170b5d4430000000,
    0x1ef3622fba094800,
    0x1a22d9f300f5138f,
...
const BLS12_377_R: U384Repr = U384Repr([
    0x02cdffffffffff68,
    0x51409f837fffffb1,
    0x9f7db3a98a7d3ff2,
    0x7b4e97b76e7c6305,
...
const BLS12_377_R2: U384Repr = U384Repr([
    0xb786686c9400cd22,
    0x0329fcaab00431b1,
    0x22a5f11162d6b46d,
    0xbfdf7d03827dc3ac,
...
const BLS12_377_FP_NON_RESIDUE_REPR: U384Repr = U384Repr([
    0xfc0b8000000002fa,
    0x97d39cf6e000018b,
    0x2072420fbfa05044,
    0xcbbcbd50d97c3802,
...
const BLS12_377_FP_NON_RESIDUE: decl_fp!(U384Repr) =
    repr_into_fp!(BLS12_377_FP_NON_RESIDUE_REPR, U384Repr, BLS12_377_FIELD);

pub const BLS12_377_FP_ZERO: decl_fp!(U384Repr) =
    repr_into_fp!(REPR_ZERO, U384Repr, BLS12_377_FIELD);

pub const BLS12_377_FP_ONE: decl_fp!(U384Repr) =
    repr_into_fp!(BLS12_377_R, U384Repr, BLS12_377_FIELD);

const BLS12_377_EXTENSION_2_FROB_COEFF_0_REPR: U384Repr = U384Repr([
    0x02cdffffffffff68,
    0x51409f837fffffb1,
    0x9f7db3a98a7d3ff2,
    0x7b4e97b76e7c6305,
...
const BLS12_377_EXTENSION_2_FROB_COEFF_1_REPR: U384Repr = U384Repr([
    0x823ac00000000099,
    0xc5cabdc0b000004f,
    0x7f75ae862f8c080d,
    0x9ed4423b9278b089,
...
pub const BLS12_377_EXTENSION_2_FIELD: Extension2<'static, U384Repr, PrimeField<U384Repr>> =
    Extension2::<'static, U384Repr, PrimeField<U384Repr>> {
        ...
        frobenius_coeffs_c1: [
            BLS12_377_EXTENSION_2_FROB_COEFF_0,
            BLS12_377_EXTENSION_2_FROB_COEFF_1,
        ],
        non_residue_mul_policy: NonResidueMulPolicy::Full,
        frobenius_coeffs_are_calculated: true,
    };

const BLS12_377_FP2_NON_RESIDUE_C0_REPR: U384Repr = U384Repr([
    0x0000000000000000,
    0x0000000000000000,
    0x0000000000000000,
    0x0000000000000000,
...
const BLS12_377_FP2_NON_RESIDUE_C1_REPR: U384Repr = U384Repr([
    0x02cdffffffffff68,
    0x51409f837fffffb1,
    0x9f7db3a98a7d3ff2,
    0x7b4e97b76e7c6305,
...
const BLS12_377_FP2_NON_RESIDUE_C0: decl_fp!(U384Repr) =
    repr_into_fp!(BLS12_377_FP2_NON_RESIDUE_C0_REPR, U384Repr, BLS12_377_FIELD);

const BLS12_377_FP2_NON_RESIDUE_C1: decl_fp!(U384Repr) =
    repr_into_fp!(BLS12_377_FP2_NON_RESIDUE_C1_REPR, U384Repr, BLS12_377_FIELD);
...
const BLS12_377_B_FOR_G2_C0_REPR: U384Repr = U384Repr([
    0x0000000000000000,
    0x0000000000000000,
    0x0000000000000000,
    0x0000000000000000,
...
pub const BLS12_377_G1_CURVE_PARAMETERS: CurveOverFpParameters<
    'static,
    U384Repr,
    PrimeField<U384Repr>,
...
pub const BLS12_377_G2_CURVE_PARAMETERS: CurveOverFp2Parameters<
    'static,
    U384Repr,
    PrimeField<U384Repr>,
...
pub const BLS12_377_EXTENSION_6_FIELD: Extension3Over2<'static, U384Repr, PrimeField<U384Repr>> =
    Extension3Over2::<'static, U384Repr, PrimeField<U384Repr>> {
        ...
        field: &BLS12_377_EXTENSION_2_FIELD,
        frobenius_coeffs_c1: [
            BLS12_377_FP6_FROB_C1_0,
            BLS12_377_FP6_FROB_C1_1,
            BLS12_377_FP6_FROB_C1_2,
            BLS12_377_FP6_FROB_C1_3,
            BLS12_377_FP6_FROB_C1_4,
            BLS12_377_FP6_FROB_C1_5,
        ],
        frobenius_coeffs_c2: [
            BLS12_377_FP6_FROB_C2_0,
            BLS12_377_FP6_FROB_C2_1,
            BLS12_377_FP6_FROB_C2_2,
            BLS12_377_FP6_FROB_C2_3,
            BLS12_377_FP6_FROB_C2_4,
            BLS12_377_FP6_FROB_C2_5,
        ],
...
pub const BLS12_377_EXTENSION_12_FIELD: Extension2Over3Over2<
    'static,
    U384Repr,
    PrimeField<U384Repr>,
> = Extension2Over3Over2::<'static, U384Repr, PrimeField<U384Repr>> {
    ...
    frobenius_coeffs_c1: [
        BLS12_377_FP12_FROB_C1_0,
        BLS12_377_FP12_FROB_C1_1,
        BLS12_377_FP12_FROB_C1_2,
        BLS12_377_FP12_FROB_C1_3,
        BLS12_377_FP12_FROB_C1_4,
        BLS12_377_FP12_FROB_C1_5,
        BLS12_377_FP12_FROB_C1_6,
        BLS12_377_FP12_FROB_C1_7,
        BLS12_377_FP12_FROB_C1_8,
        BLS12_377_FP12_FROB_C1_9,
        BLS12_377_FP12_FROB_C1_10,
        BLS12_377_FP12_FROB_C1_11,
    ],
    frobenius_coeffs_are_calculated: true,
};

pub const BLS12_377_G1_CURVE: WeierstrassCurve<
    'static,
    CurveOverFpParameters<'static, U384Repr, PrimeField<U384Repr>>,
...
pub const BLS12_377_G2_CURVE: WeierstrassCurve<
    'static,
    CurveOverFp2Parameters<'static, U384Repr, PrimeField<U384Repr>>,
...
pub const BLS12_377_G1_GENERATOR: CurvePoint<
    'static,
    CurveOverFpParameters<'static, U384Repr, PrimeField<U384Repr>>,
...
pub const BLS12_377_G2_GENERATOR: CurvePoint<
    'static,
    CurveOverFp2Parameters<'static, U384Repr, PrimeField<U384Repr>>,
...
mod test {
    ...
    fn test_g1_mul_by_zero() {
        let mut input_encoding =
            serialize_g1_point(48, &BLS12_377_G1_GENERATOR).expect("must serialize a generator");
        let scalar = [0u64];
