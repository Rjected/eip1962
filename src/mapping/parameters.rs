...
pub static BLS12_G1_MAPPING_PARAMS: Lazy<(
    ...
    super::constants::calculate_bls12_381_g1_mapping_params(
...
pub static BLS12_G2_MAPPING_PARAMS: Lazy<(
    ...
    super::constants::calculate_bls12_381_g2_mapping_params(
        &crate::engines::bls12_381::BLS12_381_EXTENSION_2_FIELD,
    )
});
