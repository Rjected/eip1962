...
pub(crate) fn is_one_mod_two(modulus: &MaxFieldUint) -> bool {
    modulus.low_u64() & 1u64 == 1u64
}

#[allow(dead_code)]
pub(crate) fn is_one_mod_three(modulus: &MaxFieldUint) -> bool {
    let one = MaxFieldUint::from(1u64);
...
pub(crate) fn is_one_mod_four(modulus: &MaxFieldUint) -> bool {
    const LAST_TWO_BITS_MASK: u64 = 3;
    modulus.low_u64() & LAST_TWO_BITS_MASK == 1u64
}

pub(crate) fn is_one_mod_six(modulus: &MaxFieldUint) -> bool {
