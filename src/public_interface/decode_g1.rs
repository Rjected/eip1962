...
use super::decode_utils::{decode_group_order_with_length, split};

use crate::errors::ApiError;

pub fn parse_group_order_from_encoding<'a>(
    encoding: &'a [u8],
...
pub fn parse_ab_in_base_field_from_encoding<'a, FE: ElementRepr, F: SizedPrimeField<Repr = FE>>(
    encoding: &'a [u8],
    modulus_len: usize,
    base_field: &'a F,
...
pub fn decode_scalar_representation<'a>(
    bytes: &'a [u8],
