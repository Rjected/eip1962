...
impl G1Api for PublicG1Api {
    fn add_points(bytes: &[u8]) -> Result<Vec<u8>, ApiError> {
        ...
        let result: Result<Vec<u8>, ApiError> =
            expand_for_modulus_limbs!(modulus_limbs, G1ApiImplementation, bytes, add_points);
    ...
    fn mul_point(bytes: &[u8]) -> Result<Vec<u8>, ApiError> {
        ...
        let result: Result<Vec<u8>, ApiError> =
            expand_for_modulus_limbs!(modulus_limbs, G1ApiImplementation, bytes, mul_point);
    ...
    fn multiexp(bytes: &[u8]) -> Result<Vec<u8>, ApiError> {
        ...
        let result: Result<Vec<u8>, ApiError> =
            expand_for_modulus_limbs!(modulus_limbs, G1ApiImplementation, bytes, multiexp);
